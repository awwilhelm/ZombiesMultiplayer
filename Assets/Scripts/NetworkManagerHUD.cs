...
namespace UnityEngine.Networking
{
    ...
    public class NetworkManagerHUD : NetworkManager
    {
        ...
        {
            var player = (GameObject)GameObject.Instantiate(prefabPlayer, playerSpawnPos, Quaternion.identity);
            NetworkServer.AddPlayerForConnection(conn, player, playerControllerId);
        }

        public GameObject GetCurrentConnection()
        {
            return tempPlayer;
        }
        ...
        void Update()
        {
            ...
            if (!NetworkClient.active && !NetworkServer.active && manager.matchMaker == null)
            {
                ...
                {
                    nC = manager.StartHost();
                }
                if (Input.GetKeyDown(KeyCode.C))
                {
                    nC = manager.StartClient();
                }
                if (nC != null)
                {
